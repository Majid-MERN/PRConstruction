...
const UpdateLabor = () => {
  ...
  <form className="shadow-lg" >
    ...
    <div className="form-group">
      ...
      <input type="text" required id="price_field" className="form-control"  value={laborData?.cnic} onChange={(e)=>{setLabourData({...laborData, cnic: e.target.value})}}/>
    </div>
    <div className="form-group">
    ...
    <div className="form-group">
      ...
      <input type="number" id="stock_field" required className="form-control"  value={laborData.contactNumber} onChange={(e)=>{setLabourData({...laborData, contactNumber: e.target.value})}}/>
    </div>
